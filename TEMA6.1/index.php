...
<body>
    ...
    <form action="world2.php" method="get">
        <br><br>
        <input type="submit" value="Peticion AJAX XMLHTTPREQUEST " name="button" onclick=" location.href='recogeCiudades(getCities.php)' ">
        <br><br>
        <input type="submit" value="Peticion AJAX JQUERY" name="button" onclick=" location.href='recogeCiudades()' ">
    </form>
</body>
</html>